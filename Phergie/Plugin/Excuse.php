 ...
 *
 * @category  Phergie
 * @package   Phergie_Plugin_Excuse
 * @author    Phergie Development Team <team@phergie.org>
 * @copyright 2008-2011 Phergie Development Team (http://phergie.org)
 * @license   http://phergie.org/license New BSD License
 * @link      http://pear.phergie.org/package/Phergie_Plugin_Excuse
 */

/**
 * Listens for the word "excuse" and throws out a random excuse in response.
 *
 * @category Phergie
 * @package  Phergie_Plugin_Excuse
 * @author   Phergie Development Team <team@phergie.org>
 ...
 * @link     http://pear.phergie.org/package/Phergie_Plugin_Excuse
 */
class Phergie_Plugin_Excuse extends Phergie_Plugin_Abstract
{
    /**
    ...
    protected function handleMsg()
    {
        ...
        if (preg_match('/excuse/i', $message)) {
            $reply = $this->excuses[array_rand($this->excuses)];
            $this->doPrivmsg($this->getEvent()->getSource(), $reply);
        }
    }

    /**
     * Array of excuses data.
     */
